...
cfg = CN()
abs_deca_dir = "/home/uwang/deca/"
# abs_deca_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..'))
cfg.deca_dir = abs_deca_dir
cfg.device = 'cuda'
cfg.device_id = '0'
cfg.local_data_dir = '/local_data'
cfg.local_ckpt_dir = '/local_data/checkpoints'
# cfg.pretrained_modelpath = os.path.join(cfg.deca_dir, 'data', 'deca_model.tar')
cfg.pretrained_modelpath = os.path.join(cfg.local_ckpt_dir, 'deca_model.tar')
cfg.output_dir = ''
...
cfg.model.flame_model_path = os.path.join(cfg.local_data_dir, 'flame_model', 'generic_model.pkl') 
